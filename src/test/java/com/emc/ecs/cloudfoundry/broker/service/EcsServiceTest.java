...
public class EcsServiceTest {
    ...
    public void createBucketDefaultTest() throws Exception {
        ...
        Map<String, Object> serviceSettings = ecs.createBucket(SERVICE_INSTANCE_ID, BUCKET_NAME, service, plan, params);
    ...
    public void createBucketWithoutParamsTest() throws Exception {
        ...
        Map<String, Object> serviceSettings =
                ecs.createBucket(SERVICE_INSTANCE_ID, BUCKET_NAME, service, plan, new HashMap<>());
